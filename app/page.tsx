          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              <div className="inline-flex items-center px-4 py-2 bg-purple-100 rounded-full text-purple-800 text-sm font-medium mb-2">
                ...
                <span>Lead-Generierung für Marketing-Agenturen</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter">
                Werden Sie mit <span className="text-gradient-purple animate-gradient">Leads</span> überschüttet
              </h1>
              <p className="text-xl text-gray-600 max-w-md">
                Leadboom unterstützt Marketing-Agenturen im DACH-Raum dabei, mehr Kunden zu gewinnen und ihr Geschäft
