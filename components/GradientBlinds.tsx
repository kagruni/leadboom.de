...
`;
    ...
    const onHeroMouseMove = (e: any) => {
      const { x, y } = e.detail;
      
      console.log('Hero mouse move:', { x, y });
    ...
    // Listen for custom mouse events from the hero section
    canvas.addEventListener("heroMouseMove", onHeroMouseMove);
    ...
    return () => {
      ...
      canvas.removeEventListener("heroMouseMove", onHeroMouseMove);
      ro.disconnect();
