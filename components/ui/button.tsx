  ...
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      ...
      size: {
        ...
        xxl: "h-16 rounded-md px-10 has-[>svg]:px-8 text-lg",
        icon: "size-9",
      },
    },
    defaultVariants: {
...
function LiquidButton({
  ...
  if (asChild) {
    // When using asChild, wrap the slotted element with liquid glass effects
    return (
      <div className="relative inline-flex">
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full pointer-events-none
            shadow-[0_1px_3px_rgba(0,0,0,0.12),0_1px_2px_rgba(0,0,0,0.08),inset_0_1px_1px_rgba(255,255,255,0.1)]
        transition-all
        dark:shadow-[0_1px_3px_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.05)]" />
        <div
