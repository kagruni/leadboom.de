...
const config = {
    ...
    // Colors for the scene - PURPLE THEME
    colors: {
        // Using HSL for easier color manipulation and vibrant results
        baseHue: 270, // Base hue for particles (270 is purple)
        hueVariance: 30, // How much the hue can vary between particles
    },
...
export default function GenerativeArtSceneV3() {
    ...
    useEffect(() => {
        ...
        renderer.setClearColor(0xffffff, 0); // Transparent white background
        ...
        for (let i = 0; i < particleCount; i++) {
            ...
            // Assign a unique, vibrant color to each particle - PURPLE THEME
